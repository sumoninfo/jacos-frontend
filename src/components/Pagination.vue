<template>
    <nav class="d-flex justify-content-between align-items-center my-5" aria-label="...">
        <div class="show">
            <select v-model="$parent.table.per_page" @change="$parent.getList()" class="form-control">
